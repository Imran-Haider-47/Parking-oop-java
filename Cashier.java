...
public class Cashier {
	...
	String Update_Sales(String date1,String date2) // update sales by checking chekin date and check out date 
	{
		int day1 = 0,day2=0,month1=0,month2 = 0; // to store months and days of the two dates
		if(date1.contains("/")) // separter between months and days
		{
		...
		days=(month2-month1)*30; // convert the monts into days
	...
	{
		File file = new File(filename); //File file = new File("C:\\Users\\pankaj\\Desktop\\test.txt"); absolute path of file  
