...
public class Customer {
	...
	String Get_cust_checkin_date(int checkid) throws IOException// Getter function to get customer checkin date
	{
	
		
			File file = new File("Customer.txt"); //File file = new File("C:\\Users\\pankaj\\Desktop\\test.txt"); absolute path of file  
